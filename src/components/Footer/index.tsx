  ...
  return (
    <div className={styles.footer}>
      <p>
        ...
        Sketchfab under <a href='https://creativecommons.org/licenses/by/4.0/'>CC BY 4.0</a>. Check out the code on{' '}
        <a href='https://github.com/RalucaNicola/3D-diorama'>GitHub</a>.
      </p>
    </div>
  );
};
